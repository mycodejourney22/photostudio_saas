...
puts "🌱 Seeding demo data for Tenant ID 2..."

tenant = Tenant.find(2)
user = User.find(2)

# Studio Location
studio_location = StudioLocation.find_or_create_by!(
  tenant_id: tenant.id,
  name: "Main Studio",
  address: "123 Photography Ave",
  city: "Lagos",
  state: "LA",
  postal_code: "100001",
  phone: "08012345678"
...
package = ServicePackage.find_or_create_by!(
  tenant_id: tenant.id,
...
tier = ServiceTier.find_or_create_by!(
  service_package: package,
...
appointment = Appointment.create!(
  ...
  payment_reference: "PMT#{SecureRandom.hex(5).upcase}",
  payment_method: "transfer",
  payment_received_at: Time.current,
  notes: "Wedding shoot at Lekki beach"
)
...
sale = Sale.create!(
  ...
  customer_id: customer.id,
  staff_member_id: nil, # assign if you have a staff_member
  sale_number: "SL#{SecureRandom.hex(4).upcase}",
  ...
  payment_method: "transfer",
  payment_reference: "SLREF#{SecureRandom.hex(3).upcase}",
...
SaleItem.create!(
  ...
  item_type: "Service",
  name: tier.name,
  description: package.description || "Premium wedding coverage",
  quantity: 1,
